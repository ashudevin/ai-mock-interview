...
export const RecordAnswer = ({
  ...
  const submitTextAnswer = async () => {
    ...
    // Generate AI feedback for text answer
    const aiResult = await generateResult(
      question.question,
      question.answer,
      textAnswer
    ...
    setAiResult(aiResult);
    // Copy text answer to userAnswer for consistency with saving logic
  ...
  const saveUserAnswer = async () => {
    ...
    try {
      ...
      if (!querySnap.empty) {
        ...
        const answerToSave = inputMethod === "voice" ? userAnswer : textAnswer;

        await addDoc(collection(db, "userAnswers"), {
          mockIdRef: interviewId,
          question: question.question,
          correct_ans: question.answer,
          user_ans: answerToSave,
  ...
  return (
    <div className="w-full flex flex-col items-center gap-8 mt-4">
          ...
          <div className="w-full p-4 border rounded-md bg-gray-50">
            ...
            <div className="flex justify-end gap-2 mt-3">
              ...
              <Button 
                ...
                disabled={textAnswer.length < 30 || isAiGenerating}
              >
                {isAiGenerating ? (
      ...
      {aiResult && (
        <div className="w-full mt-2 p-4 border rounded-md bg-gray-50">
          <h2 className="text-lg font-semibold">AI Feedback:</h2>
          <div className="flex items-center mt-2">
            <strong className="mr-2">Rating:</strong>
            <span>{aiResult.ratings}/10</span>
          </div>
          <div className="mt-2">
